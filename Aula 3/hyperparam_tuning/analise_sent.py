...
def main():
    ...
    parser.add_argument("--n-estimators", type=int, default=5, help="Quantidade de árvores a serem criadas.")
    parser.add_argument("--criterion", type=str, default="gini", help="Método utilizado para avaliar a qualidade de uma divisão de árvore.")
    ...
    clf = make_pipeline(
        ...
        RandomForestClassifier(
            n_estimators=args.n_estimators, criterion=args.criterion, random_state=2, n_jobs=None, verbose=0
        )
    )
    ...
    mlflow.log_figure(disp.plot(cmap="Greens").figure_, "text_confusion_matrix.png")
